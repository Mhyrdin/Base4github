...
#if d_Crest_LegacyUnderwater || defined(CREST_URP)
...
#if d_Crest_LegacyUnderwater || d_Crest_CustomColorTexture
...
half4 Fragment(Varyings input)
{
    ...
    if (_Crest_IsOverlayCamera && rawDepth == 0.0)
    {
        discard;
    }
