...
namespace WaveHarmonic.Crest.Editor
{
    ...
    sealed partial class RenderPipelineLightPatcher : RenderPipelinePatcher
    {
#if d_UnityHDRP
        // For Unity 6 onwards, HDAdditionalLightData.intensity is obsolete and returns Light.intensity.
        ...
        protected override void OnActiveRenderPipelineTypeChanged()
        {
            ...
            if (RenderPipelineHelper.IsHighDefinition)
            {
                if (TryGetComponent<Light>(out var light) && TryGetComponent<HDAdditionalLightData>(out var data))
                {
                    ...
                    EditorApplication.delayCall += OnActiveRenderPipelineTypeChanged;
                }
            }
#endif
        }
